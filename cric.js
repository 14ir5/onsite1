...
var shs= localStorage.getItem("humanscore");
var scs= localStorage.getItem("computerscore");
window.onload=function(){
    var  hs=document.createElement('div');
var  cs=document.createElement('div');
hs.innerHTML="Human Score :"+shs+"";
cs.innerHTML="Computer Score :"+scs+"";
...
function random(){
    return ['zero','one','two','three','four','five','six'][Math.floor(Math.random()*7)];
}
...
function swap(runs){
    ...
    cdiv.innerHTML="!!!Your Balling!!! ,your score is:"+runs+"";
...
function scoreboard(ph,pc){
    ...
    if(typeof(find) != 'undefined' && find!= null){
        ...
        if(ph>pc)
        {
            ...
            localStorage.setItem("humanscore", ++shs);
            alert("you win,computerscore:"+pc+" humanscore:"+ph+"");

        }
        else if(ph<pc){
       
          localStorage.setItem("computerscore", ++scs);
          alert("you lose,computerscore:"+pc+" humanscore:"+ph+"");
        }
        var  hs=document.createElement('div');
        var  cs=document.createElement('div');
        hs.innerHTML="Human Score :"+shs+"";
    ...
    {
        sh++;
        localStorage.setItem("humanscore", sh);
        alert("you win,computerscore:"+pc+" humanscore:"+ph+"");
    }
    else{
        sc++;
        localStorage.setItem("computerscore", sc);
        alert("you lose,computerscore:"+pc+" humanscore:"+ph+"");
    }
    var  hs=document.createElement('div');
    var  cs=document.createElement('div');
